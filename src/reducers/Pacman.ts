import { Action, ANIMATION_STEP_ACTION, CHANGE_DIRECTION_ACTION, RELEASE_PACMAN_ACTION, dotEatenAction, pelletEatenAction, FREEZE_ACTORS_ACTION } from "../actions";
...
export function pacmanReducer(state: Store.Pacman, action: Action, dots: Store.Loot[], pellets: Store.Loot[], mazePath: IMazeNavigator, events: Action[]): Store.Pacman {
  ...
  case FREEZE_ACTORS_ACTION:
    return { ...state, moving: false, eatAnimation: false }
